...
import 'package:webview_flutter/webview_flutter.dart';  // WebView dependency
                  ...
                  children: [
                    Visibility(
                      ...
                      child: const LinkScreen(
                          link: "https://onlinegrocery.pk/api/"),
                    ),
                    Visibility(
                      maintainAnimation: true,
                      maintainSize: true,
                      ...
                      child: const LinkScreen(
                          link: "https://onlinegrocery.pk/api/about.php"),
                    ),
                    Visibility(
                      maintainAnimation: true,
                      maintainSize: true,
                      ...
                      child: const LinkScreen(
                          link:
                              "https://onlinegrocery.pk/api/services.php"),
                    ),
                    Visibility(
                      maintainAnimation: true,
                      maintainSize: true,
                      ...
                      child: const LinkScreen(
                          link:
                              "https://onlinegrocery.pk/api/driver-registration.php"),
                    ),
                    Visibility(
                      maintainAnimation: true,
                      maintainSize: true,
                      ...
                      child: const LinkScreen(
                          link:
                              "https://onlinegrocery.pk/api/admin/login.php"),
                    ),
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            WebViewWidget(controller: _controller), // WebView for displaying the page
            if (isLoading)
